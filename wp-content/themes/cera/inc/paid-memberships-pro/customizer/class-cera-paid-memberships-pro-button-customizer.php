<?php
/**
 * Cera_Paid_Memberships_Pro_Button_Customizer Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package grimlock
 ...
 */
class Cera_Paid_Memberships_Pro_Button_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
...
return new Cera_Paid_Memberships_Pro_Button_Customizer();
