<?php
/**
 * Cera_Paid_Memberships_Pro_Archive_Customizer Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package grimlock
 ...
 */
class Cera_Paid_Memberships_Pro_Archive_Customizer {
...
return new Cera_Paid_Memberships_Pro_Archive_Customizer();
