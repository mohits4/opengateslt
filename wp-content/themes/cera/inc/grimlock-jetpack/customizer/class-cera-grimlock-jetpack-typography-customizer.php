<?php
/**
 * Cera_Grimlock_Jetpack_Typography_Customizer Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package grimlock
 ...
 */
class Cera_Grimlock_Jetpack_Typography_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
...
return new Cera_Grimlock_Jetpack_Typography_Customizer();
