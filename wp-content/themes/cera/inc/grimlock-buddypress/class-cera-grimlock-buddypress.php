...
class Cera_Grimlock_BuddyPress {
	...
	public function __construct() {
		...
		require_once get_template_directory() . '/inc/grimlock-buddypress/customizer/class-cera-grimlock-buddypress-archive-customizer.php';
		...
		require_once get_template_directory() . '/inc/grimlock-buddypress/customizer/class-cera-grimlock-buddypress-table-customizer.php';
