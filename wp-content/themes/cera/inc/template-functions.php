		...
		<div id="slideout-wrapper" class="slideout-wrapper slideout-menu slideout-menu-left">
			<nav id="vertical-navigation" class="grimlock-vertical-navigation main-navigation grimlock-vertical-navbar vertical-navbar">
				<div class="navbar-wrapper">
					...
					<div class="vertical-navbar-brand">
						...
						<div class="site-branding grimlock-site_identity">
							<h1 class="screen-reader-text"><a href="<?php echo esc_url( home_url( '/home' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
							<?php
							if ( function_exists( 'has_custom_logo' ) && function_exists( 'the_custom_logo' ) && has_custom_logo() ) :
								...
								<div id="site-title" class="site-title navbar-brand__title">
									<a class="site-title-link navbar-brand__title-link" href="<?php echo esc_url( home_url( '/home' ) ); ?>" rel="home" target="_self"><?php bloginfo( 'name' ); ?></a>
								</div>
								<?php
					...
					<?php
					/*$pageID = get_the_ID();		
					$parentPageID = wp_get_post_parent_id($post->ID); // Get the parent id of clicked page 				
					$categoryID = get_the_category(); // Get the categoty ID of Portfolio Fund company
					
					if($pageID == 9 || $pageID == 131 || ($parentPageID == 16) || ($categoryID[0]->cat_ID == 19)) {
						*/
				...
				/*} else {
					...
					?>
					<div class="bottom-sign-out">
						<div class="logout-menu-wrap">
						<a class="link-logout" id="wpLogout" href="<?php echo wp_logout_url( site_url().'?logout=true'); ?>" title="Logout">Logout</a>
						<a class="link-logout" style="display: none;" id="azureLogout" href="https://login.windows.net/05ae0207-0ae4-44d8-9e14-6e6aed27db0b/oauth2/logout?post_logout_redirect_uri=<?php echo site_url(); ?>
...
if ( ! function_exists( 'cera_page' ) ) :
	...
	function cera_page() {
		...
		<?php endif; 
			//the_field('content'); // custom content from pages
		?>
