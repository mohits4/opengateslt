...
<div class="tribe-events-meta-group tribe-events-meta-group-venue">
	<div class="bg-black-faded mb-2 p-3 rounded-card">
		<div class="m-0">
			...
			<div class="tribe-venue m-0"><h5><a class="text-inherit" href="<?php echo esc_url( get_the_permalink( tribe_get_venue_id() ) ); ?>"><i class="cera-icon cera-map-pin"></i> <?php echo get_the_title( tribe_get_venue_id() ); ?></a></h5></div>
