...
<?php if ( empty( $pmpro_levels ) ): ?>
	<div class="alert alert-info text-center">
		<?php esc_html_e( 'You must first create levels trough the Paid Memberships Pro settings', 'cera' ); ?>
	</div>
<?php endif; ?>
...
<div id="pmpro_levels_table" class="pmpro_checkout bg-transparent">
	<div class="row justify-content-center">
		...
		foreach ( $pmpro_levels as $level ) {
			...
			$count++;
			?>
		<div class="col-12 col-sm-6 mb-3 <?php if ( 0 === $count % 2 ) { ?>odd<?php } ?><?php if ( $current_level === $level ) { ?> active<?php } ?>">
			...
			<div class="card h-100 <?php if ( $current_level === $level ) { ?>border-primary<?php } ?>">
				...
				<div class="card-body text-center pb-3 d-flex flex-column">
					...
					if ( ! empty( $cost_text ) ) : ?>
						...
						<div class="level-short-price text-center pb-3">
