...
class Licensing
{
    ...
    public static function show_licensing_page()
    {
        ...
        echo $Sk->mo_oauth_is_customer_registered();
        ?>
" id="mo_customer_registered">
        <form style="display:none;" id="loginform"
                    action="<?php 
        echo $Sk->mo_oauth_client_get_option("\150\157\x73\164\x5f\x6e\x61\x6d\x65") . "\57\x6d\157\x61\x73\57\x6c\157\x67\151\x6e";
        ?>
"
                    target="_blank" method="post">
            <input type="email" name="username" value="<?php 
        echo $Sk->mo_oauth_client_get_option("\x6d\157\x5f\x6f\x61\165\164\x68\137\x61\144\155\x69\x6e\x5f\145\155\141\151\x6c");
        ?>
"/>
            <input type="text" name="redirectUrl"
                value="<?php 
        echo $Sk->mo_oauth_client_get_option("\x68\157\163\164\x5f\156\141\155\145") . "\x2f\155\x6f\x61\163\57\x69\156\151\x74\x69\141\x6c\x69\x7a\145\160\141\171\x6d\x65\x6e\164";
        ?>
"/>
        ...
        <form style="display:none;" id="viewlicensekeys"
                    action="<?php 
        echo $Sk->mo_oauth_client_get_option("\x68\157\x73\164\x5f\x6e\141\x6d\145") . "\x2f\155\157\x61\x73\x2f\x6c\x6f\147\151\156";
        ?>
"
                    target="_blank" method="post">
            <input type="email" name="username" value="<?php 
        echo $Sk->mo_oauth_client_get_option("\155\x6f\x5f\157\x61\x75\164\150\x5f\x61\x64\155\x69\156\137\145\155\x61\151\154");
        ?>
"/>
            <input type="text" name="redirectUrl"
                value="<?php 
        echo $Sk->mo_oauth_client_get_option("\150\x6f\163\x74\137\156\x61\155\145") . "\x2f\x6d\x6f\x61\x73\x2f\166\x69\145\167\x6c\151\x63\145\156\163\x65\153\145\171\163";
        ?>
"/>
        </form>
        ...
        echo add_query_arg(array("\x74\141\142" => "\141\143\143\x6f\165\x6e\164"), htmlentities($_SERVER["\122\105\121\125\x45\123\x54\x5f\125\122\111"]));
        ?>
">Back</a>
        <!-- JSForms Controllers -->
        <script>
